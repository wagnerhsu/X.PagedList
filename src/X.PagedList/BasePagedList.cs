...
namespace X.PagedList
{
    ...
    public abstract class BasePagedList<T> : IPagedList<T>
    {
        ...
        public bool HasNextPage => PageNumber < PageCount && PageCount != 0;
        
        public bool IsFirstPage => PageNumber == 1;

        public bool IsLastPage => PageNumber == PageCount || PageCount == 0;

        public int FirstItemOnPage => (PageNumber - 1) * PageSize + 1;

        public int LastItemOnPage => FirstItemOnPage + PageSize - 1 > TotalItemCount
            ? TotalItemCount
